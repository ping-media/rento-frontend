      ...
      <div className="relative">
        {rides?.length == 1 ? (
          <div className="border-2 rounded-lg p-2 lg:px-4 lg:py-2 shadow-md bg-white mb-3 overflow-visible">
            ...
            <div className="px-2 py-3.5 -mx-2 lg:-mx-4 bg-gray-400/20 flex flex-wrap gap-2 items-center justify-between mb-5 text-sm">
                  ...
                  <p className="text-md text-semibold">
                    ...
                    <span
                      className={`${
                        ...
                        (rides[0]?.paymentStatus === "refunded" &&
                          "bg-theme") ||
                        (rides[0]?.paymentStatus === "canceled" &&
                          "bg-theme") ||
