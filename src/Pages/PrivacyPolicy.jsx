  ...
  return (
    <div className="flex items-center justify-between w-[95%] lg:w-[90%] mx-auto py-2.5">
      <div class="leading-7 bg-white px-6 py-4 rounded-xl max-w-4xl lg:max-w-7xl mx-auto">
        ...
        <p class="text-gray-700 mb-4">
          <span class="font-semibold">Information Collection and Use:</span>
          We collect various types of information to provide and improve our
          Service.
        </p>

        <p class="text-gray-700 mb-4">
          <span class="font-semibold">Types of Data Collected:</span>
          <br />
        ...
        <p class="text-gray-700 mb-4">
          ...
          <br />
          <span class="font-semibold">Internal Use:</span> With group companies
          or authorized employees for processing data under this Privacy Policy.
        </p>
        ...
        <p class="text-gray-700 mb-4">
          <span class="font-semibold">Changes to the Policy:</span>
