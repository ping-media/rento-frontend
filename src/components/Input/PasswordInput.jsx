...
const PasswordInput = () => {
  ...
  return (
    <>
      <div className="w-full relative flex items-center shadow-[0px_5px_15px_rgba(0,0,0,0.03)]">
        <input
          required=""
          className="peer w-full h-full bg-white contrast-more:placeholder-slate-500 border-2 outline-none rounded-lg focus:border-theme focus:ring-theme focus:ring-1 px-3 py-3.5"
          placeholder="Enter your password"
          type="password"
          ref={passwordInputRef}
        />
        <button
          className="w-5 absolute block right-3 opacity-20"
          type="button"
