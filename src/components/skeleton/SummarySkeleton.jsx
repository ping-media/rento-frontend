    ...
    <div className="w-[95%] lg:w-[90%] mx-auto mt-8 animate-pulse">
      <div className="grid grid-cols-1 lg:grid-cols-10 lg:gap-4">
        ...
        <div className="col-span-3">
          <div className="border-2 border-gray-300 rounded-lg bg-white shadow-md border-t-0 mb-3">
          ...
          <div className="mb-5 border-2 bg-white border-gray-300 shadow-md rounded-lg py-2 px-4 relative">
            ...
            <>
              ...
              <div className="bg-gray-200 -mx-4 px-4 pt-2 -mb-2 rounded-b-lg pb-2">
                <div className="h-4 w-28 bg-gray-400 bg-opacity-50 rounded mb-2"></div>
          ...
          <div className="mb-5 border-2 border-gray-300 rounded-lg py-2 px-4 bg-white shadow-md mt-1">
            <div className="h-4 w-11/12 bg-gray-400 bg-opacity-50 rounded my-1"></div>
          </div>

          <button
            className="w-full rounded-lg bg-gray-400 bg-opacity-50 h-14"
            disabled
          ></button>
        </div>
      </div>
