...
const DatePicker = ({ containerOnTop, value, name }) => {
  ...
  const handleChangeDate = () => {
    if (name === "pickupDate" && selectedDate) {
      setDateLoading(true);
      ...
      if (!isNaN(newValue)) {
        ...
        setUpdatedSelectedDate(newValue);
      }
  ...
  useEffect(() => {
    if (value && name === "pickupDate" && !selectedDate) {
      ...
      >
        <div className="inline-flex items-center gap-2">
          ...
          <input
            ...
            value={
              (name === "pickupDate" ? formatDate(selectedDate) : "") ||
              (name === "dropoffDate" && !dateLoading
                ? formatDate(updatedSelectedDate)
                : "")
            }
                ...
                className={`p-2 text-center rounded-full disabled:text-gray-300 ${
                  ...
                  name == "pickupDate"
                    ? selectedDate.getDate() === day &&
                      ...
                      ? "bg-theme text-white"
                      : ""
                    : updatedSelectedDate.getDate() === day &&
                      updatedSelectedDate.getMonth() === currentMonth
                    ? "bg-theme text-white"
                    : ""
                }`}
                onClick={() =>
